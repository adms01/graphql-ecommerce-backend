...
const create_product_input_1 = require("./dto/input/create-product.input");
const product_entity_1 = require("../typeorm_entity_defs/product.entity");
const products_service_1 = require("./products.service");
const productPage_model_1 = require("./models/productPage.model");
const pagination_args_1 = require("../common/pagination.args");
const delete_product_input_1 = require("./dto/input/delete-product.input");
...
__decorate([
    ...
    __param(0, graphql_1.Args('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [delete_product_input_1.DeleteProductInput]),
    __metadata("design:returntype", Promise)
